...
网站第一版已经做成「术数知识库工作台」，不是营销页。当前以六爻作为完整样板线，同时为紫微斗数、奇门遁甲、大六壬/小六壬保留独立体系入口。
...
2. 用线上 URL 复跑桌面搜索、案例录入、体系总览和移动端布局 QA。
3. 建立至少 20 条事前锁定的真实前瞻样本后，再公开命中率。
4. 第二阶段再决定是否新建 React/Next 工程；当前静态工作台已经足够承载第一版学习、检索和体系路线图。
